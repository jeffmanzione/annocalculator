...
const alternativeIconNames = new Map<Good, string>([
  ...
  [Good.Ceramics, 'Icon_ceramics_0'],
  [Good.ClayPipes, 'Icon_tobacco_pipes_0'],
  [Good.DriedMeat, 'Icon_dried_meat_0'],
  [Good.Finery, 'Icon_traditional_clothing_0'],
  ...
  [Good.IlluminatedScript, 'Icon_scriptures_0'],
  [Good.IndigoDye, 'Icon_indigo_0'],
  [Good.Jewellery, 'Jewelry'],
  [Good.Lanterns, 'Icon_lanterns_0'],
  ...
  [Good.OrnateCandles, 'Icon_candles_0.png'],
  ...
  [Good.SpicedFlour, 'Icon_teff_flour_0'],
  [Good.SangaCow, 'Icon_watusi_0'],
  [Good.SeafoodStew, 'Icon_wat_stew_0'],
  ...
  [Good.WanzaTimber, 'Icon_wansa_wood_0'],
]);
